...
export default function Capas(props){
    ...
    return(
        <div className={`absolute top-0 right-14 h-screen w-80 lg:w-96 bg-white border-r border-gray-200 overflow-y-auto overflow-x-hidden ${props.capas === "closeCap"?'hidden':'bloque'}`} style={{zIndex:"1000"}}>
