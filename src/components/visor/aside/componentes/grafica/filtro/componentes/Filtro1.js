            ...
            <div className='flex gap-2'>
                <div className="section">
                    ...
                    <select name="select" onChange={props.captarCambiosTipo} className='text-sm px-2 h-7 rounded-sm cursor-pointer input bg-gray-200'>
                        <option value="agua_subterranea" defaultValue>Agua subterránea</option>
                        <option value="agua_superficial">Agua superficial</option>
                        <option value="puntos_vertimento">Puntos de vertimento</option>
                    </select>
                </div>
                <div className={`${props.tipo === 'agua_superficial' && props.fuente === 'Calidad de Agua y Efluentes'?'bloque':'hidden'}`}>
                ...
                <div className="flex items-center gap-2">
                    <div className="flex-1">
                        ...
                        <select name="select" onChange={props.captarCambiosFecha} className={`bg-gray-200 text-sm px-2 h-7 rounded-sm cursor-pointer input ${props.tipo  === 'agua_subterranea'?'bloque':'hidden'}`} >
                            <option value="todoAno" defaultValue>Todo</option>
                            <option value="2016">2016</option>
                            <option value="2017">2017</option>
                            <option value="2018">2018</option>
                        </select>
                        <select name="select" onChange={props.captarCambiosFecha} className={`bg-gray-200 text-sm px-2 h-7 rounded-sm cursor-pointer input ${props.tipo === 'agua_superficial'?'bloque':'hidden'}`} >
                            <option value="todoAno" defaultValue>Todo</option>
                            <option value="2018">2018</option>
                            <option value="2019">2019</option>
                        </select>
                        <select name="select" onChange={props.captarCambiosFecha} className={`bg-gray-200 text-sm px-2 h-7 rounded-sm cursor-pointer input ${props.tipo  === 'puntos_vertimento'?'bloque':'hidden'}`} >
                            <option value="todoAno" defaultValue>Todo</option>
                            <option value="2016" >2016</option>
                            <option value="2017">2017</option>
                            <option value="2018">2018</option>
