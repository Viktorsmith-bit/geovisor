...
function Em2017T2(){
    ...
    useEffect(()=>{
        async function PromiseDB(){
            const starCountCor = ref(app, "em_2017_t2");
                ...
                <div className='overflow-auto overscroll-auto h-96 '>
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className='border border-gray-300 p-1'>Conductividad</td><td className='border border-gray-300 p-1'>{feature.properties.Conductivi}</td><td className='border border-gray-300 p-1'>{feature.properties.Uni_con}</td><td className='border border-gray-300 p-1'>{feature.properties.ECA_Cond}</td>
                            </tr>
                            <tr>
                                <td className='border border-gray-300 p-1'>Oxígeno Disuelto</td><td className='border border-gray-300 p-1'>{feature.properties.OD}</td><td className='border border-gray-300 p-1'>{feature.properties.Uni_OD}</td><td className='border border-gray-300 p-1'>{feature.properties.Uni_OD_1}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td className='border border-gray-300 p-1'>DBO5</td><td className='border border-gray-300 p-1'>{feature.properties.DBO5}</td><td className='border border-gray-300 p-1'>{feature.properties.Uni_ZT}</td><td className='border border-gray-300 p-1'>{feature.properties.ECA_DB05}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td className='border border-gray-300 p-1'>Nitritos</td><td className='border border-gray-300 p-1'>{feature.properties.N_Nitritos}</td><td className='border border-gray-300 p-1'>{feature.properties.Uni_ZT}</td><td className='border border-gray-300 p-1'>{feature.properties.ECA_Nitrit}</td>
                            </tr>
                            <tr>
...
export default React.memo(Em2017T2);